...
<body class="row">
<div class="col s8 z-depth-2 right" style="padding: 0 30px" id="foundpost">
    <a href="ManagerServlet?op=viewpost" class="rbackpage black-text"><i class="material-icons right">arrow_back</i></a>
    <h2 class="center">招领板块</h2>
    <div class="divider"></div>

    <!-- filter -->
    <a class="waves-effect waves-blue modal-trigger card my-5" href="#modal-tags" id="tags-select">筛&nbsp;&nbsp;选&nbsp;&nbsp;标&nbsp;&nbsp;签</a>
    <div class="my-5">
        <form action="ManagerServlet?op=selsearch" id="search-form">
    ...
    <div id="modal-tags" class="modal bottom-sheet">
        <form action="ManagerServlet?op=seltags">
    ...
    <script>
        $(document).ready(function(){
            ...
            function getTenMorePosts() {
                let url = "ManagerServlet?op=gettentypemoreposts&postBeginIdx=" + postBeginIdx;
                postBeginIdx += 10;
                console.log("click");
            ...
            function addNewPost(data) {
                ...
                for (let i = 0; i < len; ++i) {
                    ...
                    document.querySelector("#foundpost").insertBefore(postNode, document.querySelector("#loadMoreBtn"));
                }
                if (len < 10) {
                    let buttomline = document.createElement("div");
                    buttomline.innerHTML = '<div class="divider"></div><h5 class="center my-5">已经到底啦~</h5>'
                    document.querySelector("#foundpost").insertBefore(buttomline, document.querySelector("#loadMoreBtn"));
                    $("#loadMoreBtn").fadeOut();
                }
                $('.modal').modal();
            }
