...
<body class="row">
    <div class="col s8 z-depth-2 right" style="padding: 0 30px" id="viewpost">
        ...
        <div class="carousel carousel-slider center" style="height: 300px">
            <a href="#one!" class="carousel-item"><img src="<%=path%>/img/viewpost-carousel-1.jpg" alt=""></a>
            <a href="#two!" class="carousel-item"><img src="<%=path %>/img/viewpost-carousel-2.jpg" alt=""></a>
            <a href="#three!" class="carousel-item"><img src="<%=path%>/img/viewpost-carousel-3.jpg" alt=""></a>
            <a href="#four!" class="carousel-item"><img src="<%=path%>/img/viewpost-carousel-4.jpg" alt=""></a>
            <a href="#five!" class="carousel-item"><img src="<%=path%>/img/viewpost-carousel-5.jpg" alt=""></a>
        </div>

        <!-- section -->
        <div class="row my-5">
            <div class="col s4 sect">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <a href="ClientServlet?op=foundpost"><img class="activator" src="<%=path%>/img/found-section.jpg" alt="foundpost"></a>
                    </div>
            ...
            <div class="col s4 sect">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <a href="ClientServlet?op=lostpost"><img class="activator" src="<%= path%>/img/lost-section.jpg"></a>
                    </div>
                    <div class="card-content">
            ...
            <div class="col s4 sect">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <a href="ClientServlet?op=viewannounce"><img class="activator" src="<%= path%>/img/ann-section.jpg"></a>
                    </div>
                    <div class="card-content">
                        <span class="card-title activator grey-text text-darken-4">本站公告<i class="material-icons right">more_vert</i></span>
                    </div>
                    <div class="card-reveal">
                        <span class="card-title grey-text text-darken-4">本站公告<i class="material-icons right">close</i></span>
                        <p style="margin: 20px 0 0 0;line-height:2rem">在这里，管理员会发布有关本站的公告，网站的所有用户必须遵守这些约定。</p>
                    </div>
                </div>
            </div>
        </div>
