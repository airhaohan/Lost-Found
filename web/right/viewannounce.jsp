        ...
        <c:forEach items="${sessionScope.initanns}" var="ann">
            <ul class="collapsible popout my-5 py-3">
                <li class="card">
                    ...
                    <div class="collapsible-body grey-text text-darken-4">${ann.getContent()}</div>
...
<script>
    $(document).ready(function(){
        ...
        function getTenMoreAnns() {
            let url = "ClientServlet?op=gettenmoreanns&annBeginIdx=" + annBeginIdx;
            annBeginIdx += 10;
            console.log("click");
            ...
            for (let i = 0; i < len; ++i) {
                ...
                annNode.innerHTML = '<ul class="collapsible popout my-5 py-3" >\
                    <li class="card">\
                        ...
                        <div class="collapsible-body grey-text text-darken-4">' + data[i].content + '</div>\
